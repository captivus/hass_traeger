# TODO
* Add predicted time for each of the set temps on the probes
* We really need a service that will run and collect all of the streamed data from the grill and save it
  ...
  * We then sit a visualization tool on top of it
...
* The historical data tab isn't working now -- it's not visible at all.
* Export to CSV functionality is broken in the app
